...
using AmazonTrManagment.Sessions;
using AmazonTrManagment.Web.Models.Account;
using AmazonTrManagment.Web.Views.Shared.Components.TenantChange;

namespace AmazonTrManagment.Web.Controllers
{
    public class AccountController : AmazonTrManagmentControllerBase
    {
