...
namespace AmazonTrManagment.Scraper
{
	public class UserAgents
	{
		...
		{
			string[] userAgents = GetUserAgentList();
			Random r = new();
			return userAgents[r.Next(userAgents.Length)];
		}

		private string[] GetUserAgentList()
		{
			string[] userAgentList = { "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36",
