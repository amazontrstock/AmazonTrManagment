...
using AmazonTrManagment.Models.TokenAuth;
...
{
    public abstract class AmazonTrManagmentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AmazonTrManagmentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AmazonTrManagmentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AmazonTrManagmentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AmazonTrManagmentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AmazonTrManagmentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AmazonTrManagmentDbContext, Task<T>> func)
        {
            T result;
